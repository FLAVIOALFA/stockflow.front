...
export interface paths {
    "/branches": {
        ...
        get: operations["get/branches"];
        put?: never;
        post: operations["post/branches"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/branches/{id}": {
        ...
        get: operations["get/branches/{id}"];
        put: operations["put/branches/{id}"];
        post?: never;
        delete: operations["delete/branches/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/brands": {
        ...
        get: operations["get/brands"];
        put?: never;
        post: operations["post/brands"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/brands/{id}": {
        ...
        get: operations["get/brands/{id}"];
        put: operations["put/brands/{id}"];
        post?: never;
        delete: operations["delete/brands/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/daily-closings": {
        ...
        get: operations["get/daily-closings"];
        put?: never;
        post: operations["post/daily-closings"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/daily-closings/{id}": {
        ...
        get: operations["get/daily-closings/{id}"];
        put: operations["put/daily-closings/{id}"];
        post?: never;
        delete: operations["delete/daily-closings/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/movements": {
        ...
        get: operations["get/movements"];
        put?: never;
        post: operations["post/movements"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/movements/{id}": {
        ...
        get: operations["get/movements/{id}"];
        put: operations["put/movements/{id}"];
        post?: never;
        delete: operations["delete/movements/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/stocks": {
        ...
        get: operations["get/stocks"];
        put?: never;
        post: operations["post/stocks"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/stocks/{id}": {
        ...
        get: operations["get/stocks/{id}"];
        put: operations["put/stocks/{id}"];
        post?: never;
        delete: operations["delete/stocks/{id}"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        Branch: {
            ...
            stocks?: {
                ...
                product?: {
                    ...
                    details?: (components["schemas"]["SpecificationsMachineryComponent"] | components["schemas"]["SpecificationsIceCreamsComponent"])[];
                    /** Format: date-time */
                    createdAt?: string;
                    /** Format: date-time */
                    updatedAt?: string;
        ...
        SpecificationsMachineryComponent: {
            id?: number;
            /** @enum {string} */
            __component?: "specifications.machinery";
            model?: string;
            serialNumber?: string;
            /** @enum {string} */
            condition?: "new" | "used";
        ...
        SpecificationsIceCreamsComponent: {
            id?: number;
            /** @enum {string} */
            __component?: "specifications.ice-creams";
            flavor?: string;
            description?: string;
            /** @enum {string} */
            presentation?: "Caja" | "Balde" | "Unidad" | "Pack";
            /** Format: float */
            units?: number;
            /** Format: date */
        ...
        DailyClosingListResponse: {
            data?: components["schemas"]["DailyClosing"][];
            meta?: {
                pagination?: {
                    page?: number;
                    pageSize?: number;
        ...
        MovementRequest: {
            data: {
                ...
                /** @enum {string} */
                type?: "buy" | "delivery_to_branch" | "inventory_adjustment" | "decrease";
                /** @enum {string} */
                state?: "requested" | "confirmed";
                items?: components["schemas"]["InventoryMovementDetailComponent"][];
                locale?: string;
                localizations?: (number | string)[];
            };
        };
        ...
        InventoryMovementDetailComponent: {
            id?: number;
            product?: {
                id?: number;
                documentId?: string;
...
export interface operations {
    ...
    "get/daily-closings": {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DailyClosingListResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "post/daily-closings": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DailyClosingRequest"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DailyClosingResponse"];
                };
            };
            /** @description Bad Request */
            400: {
